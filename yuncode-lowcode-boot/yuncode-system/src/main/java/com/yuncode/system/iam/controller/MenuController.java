...
import com.yuncode.system.iam.dto.AddMenuPermissionDTO;
...
public class MenuController {
    ...
    public Result<Void> updateMenu(@Valid @RequestBody MenuForm menuForm) {
    ...
    public Result<Void> addPermissions(@Valid @RequestBody AddMenuPermissionDTO dto) {
