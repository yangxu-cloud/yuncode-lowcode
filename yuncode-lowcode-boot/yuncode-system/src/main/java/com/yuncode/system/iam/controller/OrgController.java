...
import com.yuncode.system.iam.dto.OrgCreateDTO;
import com.yuncode.system.iam.dto.OrgQueryDTO;
import com.yuncode.system.iam.entity.SysOrg;
import com.yuncode.system.iam.service.OrgService;
import com.yuncode.system.iam.service.OrgUserService;
import com.yuncode.system.iam.vo.OrgTreeNode;
import com.yuncode.system.iam.vo.OrgVO;
...
public class OrgController {
    ...
    public Result<List<OrgVO>> getOrgList(@Valid @RequestBody OrgQueryDTO queryDTO) {
    ...
    public Result<Void> addOrg(@Valid @RequestBody OrgCreateDTO dto) {
    ...
    public Result<Void> updateOrg(@Valid @RequestBody SysOrg org) {
    ...
    public Result<List<com.yuncode.system.iam.vo.UserOrgVO>> getUserOrgs(
            @Parameter(description = "用户ID") @PathVariable Long userId) {
        log.info("获取用户组织关系, userId={}", userId);
        try {
            List<com.yuncode.system.iam.vo.UserOrgVO> userOrgs = orgUserService.getUserOrgs(userId);
