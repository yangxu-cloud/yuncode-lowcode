package com.yuncode.system.app.controller;
...
import com.yuncode.system.app.service.CategoryService;
...
public class ApplicationController {
    ...
    public Result<Void> createApplication(@Valid @RequestBody ApplicationForm form) {
        try {
    ...
    public Result<Void> updateApplication(@Valid @RequestBody ApplicationForm form) {
        try {
    ...
    public Result<com.yuncode.system.app.entity.SysAppCategory> createCategory(
            @PathVariable String appId,
            @Valid @RequestBody java.util.Map<String, Object> body) {
        try {
            String name = (String) body.get("name");
            Long parentId = body.get("parentId") != null ? Long.valueOf(body.get("parentId").toString()) : null;
            com.yuncode.system.app.entity.SysAppCategory category = categoryService.createCategory(appId, name, parentId);
