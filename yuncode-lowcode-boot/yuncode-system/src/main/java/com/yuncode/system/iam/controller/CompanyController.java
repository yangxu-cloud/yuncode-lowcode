...
import com.yuncode.system.iam.dto.CompanyQueryDTO;
import com.yuncode.system.iam.entity.SysCompany;
import com.yuncode.system.iam.service.CompanyService;
import com.yuncode.system.iam.vo.CompanyVO;
...
public class CompanyController {
    ...
    public Result<List<CompanyVO>> getCompanyList(
            @Valid @RequestBody CompanyQueryDTO queryDTO,
    ...
    public Result<Void> addCompany(@Valid @RequestBody SysCompany company) {
    ...
    public Result<Void> updateCompany(@Valid @RequestBody SysCompany company) {
