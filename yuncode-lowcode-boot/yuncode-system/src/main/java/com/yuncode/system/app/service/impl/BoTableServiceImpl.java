...
import com.yuncode.system.app.entity.SysAppCategory;
import com.yuncode.system.app.entity.SysBoField;
import com.yuncode.system.app.entity.SysBoTable;
import com.yuncode.system.app.mapper.SysAppCategoryMapper;
import com.yuncode.system.app.mapper.SysBoFieldMapper;
...
public class BoTableServiceImpl implements BoTableService {
    ...
    public long countByAppId(String appId) {
        return boTableMapper.selectCountByAppId(appId);
    }
